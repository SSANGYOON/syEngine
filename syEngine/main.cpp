...
#pragma comment(lib, "Engine_SOURCE.lib") 
    ...
    _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_SYENGINE, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_SYENGINE));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.lpszMenuName = MAKEINTRESOURCEW(IDC_SYENGINE);
